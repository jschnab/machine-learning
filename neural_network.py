...
if __name__ == "__main__":
    ...
    #model = NeuralNet(hidden_size=60, n_labels=10, n_iter=3360, lamb=1, alpha=0.4) #takes 17 min to achieve 95 % accuracy on the test sample
    model = NeuralNet(hidden_size=784, n_labels=10, n_iter=600, lamb=1, alpha=0.4) #takes 17 min to achieve 94 % accuracy on test sample
